...
describe('Color Consistency Tests', () => {
  it('renders color swatches that can be analyzed', () => {
    render(
      <UILint enabled={true}>
        <div>
          <div style={{ backgroundColor: '#3B82F6' }} data-testid="color-1">Blue 1</div>
          <div style={{ backgroundColor: '#2563EB' }} data-testid="color-2">Blue 2</div>
          <div style={{ backgroundColor: '#3575E2' }} data-testid="color-3">Blue 3</div>
        </div>
      </UILint>
    );
