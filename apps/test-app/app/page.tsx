    ...
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <header>
          ...
          <SubHeading>This page has intentional UI inconsistencies for testing</SubHeading>
        </header>

        {/* Buttons Section - Inconsistent styles */}
        <section>
          <h2 className="text-xl font-bold mb-4 text-gray-800">Buttons (Inconsistent)</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-4 text-gray-900">Cards (Inconsistent)</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-5 rounded-md shadow border border-gray-100">
              ...
              <p className="text-gray-500 mt-2 text-sm">
                This card has different padding (p-5), border-radius (rounded-md), and includes a border.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 mt-3 text-base">
                This card has larger padding (p-8), bigger radius (rounded-2xl), and stronger shadow.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          <h2 className="text-xl font-bold mb-6 text-gray-800">Spacing (Inconsistent)</h2>
          <div className="space-y-3">
            ...
            <div className="bg-blue-100 py-3 px-7 rounded">Padding: py-3 px-7 (mixed)</div>
          </div>
        </section>

        {/* Colors Section - Similar but not identical colors */}
        <section>
          <h2 className="text-xl font-bold mb-4 text-gray-800">Colors (Similar but Different)</h2>
          <div className="flex flex-wrap gap-4">
            ...
            <div className="w-20 h-20 rounded flex items-center justify-center text-white text-xs" style={{ backgroundColor: '#3B82F6' }}>
              #3B82F6
            </div>
            <div className="w-20 h-20 rounded flex items-center justify-center text-white text-xs" style={{ backgroundColor: '#2563EB' }}>
              #2563EB
            </div>
            <div className="w-20 h-20 rounded flex items-center justify-center text-white text-xs" style={{ backgroundColor: '#3575E2' }}>
              #3575E2
            </div>
          </div>
        </section>
