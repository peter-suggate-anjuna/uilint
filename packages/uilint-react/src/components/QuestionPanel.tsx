...
export function QuestionPanel() {
  ...
  const handleSaveToStyleGuide = async () => {
    // TODO: Save answers to style guide
...
function generateQuestionsFromIssues(issues: typeof import('../types').UILintIssue[]): StyleQuestion[] {
  ...
  if (spacingIssues.length > 0) {
    questions.push({
      ...
      options: [
        ...
        { value: 'tailwind', label: 'Tailwind scale (4, 8, 12, 16, 20, 24...)' },
      ],
    });
  }
  ...
  if (typographyIssues.length > 0) {
    questions.push({
      ...
      options: [
        { value: '400-600-700', label: 'Regular (400), Semibold (600), Bold (700)' },
        { value: '400-500-700', label: 'Regular (400), Medium (500), Bold (700)' },
        { value: '300-400-600', label: 'Light (300), Regular (400), Semibold (600)' },
      ],
    });
  }
